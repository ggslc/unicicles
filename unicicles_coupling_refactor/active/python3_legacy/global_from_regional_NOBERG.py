...
def parse_commandline(argv):
  ...
  return GrIS_orog_filename, AIS_orog_filename, global_orog_filename_in, global_orog_filename_out, GrIS_icecouple_filename, AIS_icecouple_filename, global_icecouple_filename_out

if __name__ == "__main__":

    GrIS_orog_filename, AIS_orog_filename, global_orog_filename_in, global_orog_filename_out, GrIS_icecouple_filename, AIS_icecouple_filename, global_icecouple_filename_out = parse_commandline(sys.argv)
