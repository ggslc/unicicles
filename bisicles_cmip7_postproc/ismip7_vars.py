...
CF_FIELD_MAPPING = {
    ...
    "base": {
        "cmip7_name": "base",
        "standard_name": "ice_sheet_base_altitude",
        "long_name": "Ice Sheet Base Altitude",
        "cmip7_units": "m",
        "bisicles_units": "m",
        "conversion_factor": 1.0,
        "cell_methods": "area: time: mean where ice_sheet",
    ...
    # Annoyingly, ISMIP7 does not follow the CMIP7 rules: there conversio_factor = 1
    "sftgrf": {
        "cmip7_name": "sftgrf",
    ...
    "licalvf": {
        ...
        "modeling_realm": "landIce",
        "cmip7_compliant": True,
        "comment": "Negative values indicate calving (loss of ice mass).",
    },
    "ligroundf": {
    "cmip7_name": "ligroundf",
    "standard_name": "land_ice_mass_flux_across_grounding_line",
    "long_name": "Land Ice Calving Flux",
    "cmip7_units": "kg m-2 s-1",
    "bisicles_units": "kg m-2 yr-1",
    "conversion_factor": _KG_M2_A_TO_KG_M2_S,
    ...
    "modeling_realm": "landIce",
    "cmip7_compliant": True,
    "comment": "Negative values indicate flux out (loss of ice mass).",
},
    "strbasemag": {
        "cmip7_name": "strbasemag",
        "standard_name": "land_ice_basal_drag",
